...
/// This example's own bootstrap config — the hand-written counterpart of
/// what `xr new`/`xr convert` generate automatically (see
...
pub fn config() -> Value {
    ...
    config["app_name"] = json!(larust_support::config_env::env_or("APP_NAME", "blog"));
